      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-card rounded-2xl p-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/mock-test" className="px-3 py-1.5 text-sm text-brand-400 hover:text-brand-300 rounded-lg hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Life in the UK Practice Test →</Link>
          </div>
        ...
        <div className="mt-4 flex gap-2 justify-center flex-wrap">
          ...
          <Link href="/articles/how-to-pass-the-life-in-the-uk-test-first-time" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Pass First Time</Link>
          <Link href="/articles/how-long-does-it-take-to-study-for-the-life-in-the-uk-test" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">How Long to Study</Link>
          <Link href="/articles/life-in-the-uk-test-what-to-expect-on-the-day" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Test Day Guide</Link>
          <Link href="/articles/how-much-does-the-life-in-the-uk-test-cost" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Life in the UK Test Fee</Link>
          <Link href="/articles/life-in-the-uk-test-questions-pdf" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Questions PDF?</Link>
          <Link href="/articles/do-you-need-a-course-for-the-life-in-the-uk-test" className="px-4 py-3 text-sm text-brand-400 hover:text-brand-300 active:opacity-70 rounded-xl hover:bg-brand-500/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500">Need a Course?</Link>
