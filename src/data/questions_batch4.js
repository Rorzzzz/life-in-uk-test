...
export const QUESTIONS_BATCH4 = [
...

  {
    ...
    options: ['The pound sterling (£)', 'The Irish punt', 'The euro (€)', 'The US dollar ($)'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['Snowdon (Yr Wyddfa)', 'Ben Nevis', 'Scafell Pike', 'Slieve Donard'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['The shamrock', 'The leek', 'The rose', 'The thistle'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['South-west England', 'Northern Ireland', 'Scotland', 'Wales'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['Ireland', 'Belgium', 'France', 'The Netherlands'],
    answer: 2,
