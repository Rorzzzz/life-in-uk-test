...
export const QUESTIONS_BATCH4 = [
...

  {
    ...
    options: ['The pound sterling (£)', 'The US dollar ($)', 'The Irish punt', 'The euro (€)'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['Scotland and Northern Ireland', 'England and Wales', 'Wales and Scotland', 'England and Scotland'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['St George, St David and St Andrew', 'St George, St Andrew and St Patrick', 'St Andrew, St Patrick and St David', 'St George, St Patrick and St David'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['The rose', 'The leek', 'The thistle', 'The shamrock'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['Wales', 'Northern Ireland', 'South-west England', 'Scotland'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['Ireland', 'Great Britain', 'The Isle of Man', 'The Isle of Wight'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['Ireland', 'France', 'Belgium', 'The Netherlands'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['The Irish Sea', 'The Celtic Sea', 'The North Sea', 'The English Channel'],
    answer: 2,
