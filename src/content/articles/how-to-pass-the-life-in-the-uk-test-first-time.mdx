...
You need the content of the handbook — every test question comes from it. The book costs [VERIFY: confirm current retail price from TSO] new. It is also available in libraries and second-hand. Some test prep sites offer the handbook content in a revised format, but the official book is the safest reference.
