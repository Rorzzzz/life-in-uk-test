...
The Official Life in the UK Test app (published by TSO, the official publisher of the handbook) is available for [VERIFY: confirm current App Store/Play Store price] on iOS and Android. It contains:
