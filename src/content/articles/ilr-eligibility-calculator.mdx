---
title: "ILR Eligibility Calculator — Free Exact Date Finder 2026"
description: "Free ILR eligibility calculator — find out your exact qualifying date and total cost in seconds. Based on current Home Office rules for all visa routes."
date: "2026-04-30"
...
ILR applications that are submitted without the Life in the UK test pass, B1 certificate (if required), or sufficient qualifying time are refused. The £3,226 fee is not refunded on refusal. Use our [free ILR refusal risk checker](/ilr-risk-check) to check every requirement before submitting.
...
- [Mock exam](/mock-test) — full 24-question timed test, just like the real thing
