...
There is no minimum gap between attempts — if there is an available slot tomorrow, you can book it. In practice, availability in busy cities may mean waiting a week or two. Read our full [booking guide](/articles/how-to-book-the-life-in-the-uk-test) for more detail.
