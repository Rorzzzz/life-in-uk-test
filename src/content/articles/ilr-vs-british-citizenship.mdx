...
As of 2026, ILR costs £2,885 per person. The citizenship (naturalisation) fee is [VERIFY: confirm exact naturalisation fee from GOV.UK — was £1,630 at time of writing]. Both fees are set by the Home Office and subject to change — check GOV.UK for current figures before applying.
