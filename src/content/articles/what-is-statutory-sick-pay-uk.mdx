...
| Weekly rate | [VERIFY: check current SSP weekly rate at GOV.UK — changes each April] |
| Lower Earnings Limit | [VERIFY: check current figure at GOV.UK — changes each April] |
...
2. Earn at least the Lower Earnings Limit per week on average [VERIFY: current figure at GOV.UK]
