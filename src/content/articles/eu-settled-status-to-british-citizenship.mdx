...
Practice with our [free practice tests](/mock-test) and work through the [hardest questions](/hardest-life-in-the-uk-test-questions) that most people struggle with. Our [cheat sheet](/cheat-sheet) covers the key dates, facts, and figures that come up most often.
...
3. **Use a share code — not a paper document — to evidence Settled Status.** Settled Status is digital only. Generate a [share code](/articles/how-to-get-a-share-code) through the UKVI website and include it with your application. The Home Office can verify it directly.
...
Prepare for the Life in the UK test with our [free practice tests](/mock-test) and [practice questions](/practice). Our [cheat sheet](/cheat-sheet) covers the key facts most people miss. Use the [citizenship planner](/citizenship-planner) to calculate your exact eligibility date based on your UK arrival and Settled Status grant dates.
