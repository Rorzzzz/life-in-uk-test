...
| Passport (not included) | [VERIFY: current passport fee on GOV.UK] |
...
**A British passport**: After receiving citizenship, you can apply for a British passport. This is a separate fee. [VERIFY: current adult and child passport fees on GOV.UK] Budget for this if getting a British passport is your goal.
...
No. The citizenship application fee of £1,709 is not refunded if your application is refused. The ceremony fee of £130 is only relevant if you are approved, so refunds on that element [VERIFY: confirm full refund policy on GOV.UK].
...
**Fee waivers for children's citizenship registration** may be available in limited circumstances related to child welfare. [VERIFY: check GOV.UK for current fee waiver policy for children]
