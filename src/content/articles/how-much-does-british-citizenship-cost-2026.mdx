...
2. **Pass the Life in the UK test before your ILR application.** The same Unique Reference Number (URN) — emailed to you on the day, not a printed certificate — is used for both ILR and citizenship applications. You do not need to retake the test. Saving £50 per person and avoiding the hassle is a small but real benefit.
