...
You are not required to buy the official handbook, but everything in the test comes from it. The handbook costs [VERIFY: confirm current retail price from TSO]. Free practice questions based on the handbook are available at [passtheuktest.co.uk](https://passtheuktest.co.uk).
...
The official handbook. Every test question comes from this book. Available to buy for [VERIFY: confirm current retail price from TSO].
