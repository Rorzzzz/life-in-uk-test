---
title: "180-Day Rule for ILR UK — Free Absence Check 2026"
description: "The 180-day ILR rule limits you to 180 days outside the UK in any 12-month period. Find out how it's counted and check your own trips for free."
date: "2026-04-30"
category: "Immigration"
readTime: "8 min read"
published: true
keywords: ["180 day rule ILR UK", "ILR absence rule", "180 days outside UK ILR", "ILR qualifying period absences", "UK absence calculator ILR", "continuous residence UK ILR", "breaks in continuous residence ILR"]
---
...
If UKVI finds you have exceeded 180 days in any 12-month window, they can refuse your ILR application. The fee (£3,226 per person from 8 April 2026) is not refunded if your application is refused. Before applying, run our [free ILR refusal risk checker](/ilr-risk-check) to identify any issues.
...
## Other Ways Continuous Residence Can Be Broken

The 180-day rule is the most common issue, but it is not the only way continuous residence can be broken during your ILR qualifying period.

**Letting your visa expire while abroad.** If you leave the UK and your visa expires before you return, you have broken continuous residence — even if your total days outside the UK are well under 180. Always check your visa expiry date before travelling, and renew before you go if it is close to expiry.

**Imprisonment.** A custodial sentence — in the UK or abroad — breaks continuous residence. Time spent in prison does not count toward your qualifying period.

**Crown service exemption.** If you work for the UK government abroad — diplomatic service, armed forces, or similar — those absences do not count against the 180-day limit. This is a specific exemption in the Immigration Rules. If this applies to you, get written confirmation of your posting from your employer to include with your ILR application.

**When your qualifying period starts.** Your qualifying period normally starts on the date you first entered the UK on the relevant visa, or the date your visa was granted if you were already in the UK. Time on a previous, unrelated visa (such as a student visa before switching to Skilled Worker) does not count.

---

## ILR Absences vs Citizenship Absences — Different Limits

Do not confuse the ILR absence rule with the British citizenship absence rule that applies after you get ILR.

- **ILR (this rule):** No more than 180 days outside the UK in any rolling 12-month window during your qualifying period.
- **British citizenship:** No more than 450 days outside the UK across the full 5-year period before applying, and no more than 90 days in the 12 months immediately before you apply.

It is possible to meet the ILR rule (no single window over 180 days) but still fail the citizenship rule if your total absences across 5 years exceed 450 days. If you are planning to apply for citizenship after ILR, track both limits from the start. See our [ILR vs British citizenship guide](/articles/ilr-vs-british-citizenship) for a full comparison.
