...
| Absence rule | No more than 540 days outside the UK over 10 years; no more than 180 days in any single 12-month rolling window |
...
📌 The 10-year absence limit is 540 days total (not 180 per year × 10) — but any single year must still stay within 180 days  
...
- **Total absences**: No more than 540 days outside the UK over the entire 10-year qualifying period
- **Per-year limit**: No more than 180 days in any single rolling 12-month window

Both rules apply simultaneously. You can have a year with 200 days abroad (which would breach the rolling window rule) even if your total is under 540 days — so the rolling window check is just as important as the total.
...
| Absences (total) | Max 540 days | Max 360 days (180 × 2 rolling 12-month windows effectively) |
...
❌ **Submitting without checking every 12-month absence window** — A single year with more than 180 days outside the UK disqualifies you even if your total absences are well under 540. This mistake appears repeatedly in long residence applications.
