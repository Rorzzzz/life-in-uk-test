---
title: "ILR Processing Time 2026 — the Real Wait Time"
description: "ILR processing takes up to 6 months on the standard service in 2026. See real applicant timelines, plus Priority and Super Priority options that cost extra."
date: "2026-05-05"
category: "Immigration"
readTime: "7 min read"
published: true
keywords: ["ILR processing time 2026", "how long does ILR take", "ILR decision time", "ILR priority service", "indefinite leave to remain waiting time", "how to check ILR application status", "track ILR application", "how long does indefinite leave to remain take", "ILR application how long 2026", "when will I get my ILR decision"]
---
...
The Home Office provides an online tracker where you can check the status of your ILR application at any point after submitting.

**Step-by-step:**
1. Go to [www.gov.uk/track-your-application](https://www.gov.uk/track-your-application)
2. Enter your unique application reference number (GWF or UAN number from your submission confirmation)
3. Enter your date of birth
4. The tracker shows your current status — typically "received", "in progress", or "decision made"

The tracker does not give a predicted decision date. Most applicants see the status stay at "in progress" for the majority of the wait period. The decision appears on the tracker without advance warning — often before any email or letter arrives.

**What the status messages mean:**
- **Received** — your application has been logged but not yet assigned to a caseworker
- **In progress** — a caseworker is actively working on your application
- **Decision made** — a decision has been reached; check your eVisa account and email immediately
- **Waiting for information** — the caseworker has requested additional documents; respond promptly

Check the tracker weekly, not daily. Frequent checks will not speed up processing.
