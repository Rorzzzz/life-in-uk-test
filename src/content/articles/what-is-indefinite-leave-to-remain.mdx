...
If you need to pass the test, use [free mock test practice](/mock-test) to prepare. See the [test topics guide](/articles/life-in-the-uk-test-chapter-by-chapter-guide) for a breakdown of what appears in the exam.
...
If you have an older BRP card showing ILR, it remains valid as evidence of your status. You can also [create a UKVI account](/articles/how-to-create-a-ukvi-account) to get the digital version.
