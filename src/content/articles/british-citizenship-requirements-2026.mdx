...
| Processing time | [VERIFY: check GOV.UK for current processing times] |
...
You need to demonstrate B1 level English. The same accepted tests that apply for [ILR also apply for citizenship](/articles/do-i-need-a-b1-english-test-for-ilr):
...
The same nationality and degree exemptions that apply to ILR also apply to citizenship. [VERIFY: confirm exemption list on GOV.UK for citizenship specifically]
...
**Passport**: A British passport is not included in the citizenship fee. An adult British passport is a separate cost. [VERIFY: current adult passport fee]
...
[VERIFY: check GOV.UK for current naturalisation processing times. Include specific figure once verified.]
...
**Disability**: Physical or mental conditions that prevent meeting the English or Life in the UK test requirements may lead to exemption. [VERIFY: exact criteria on GOV.UK]
...
[VERIFY: include specific processing time from GOV.UK once confirmed.]
