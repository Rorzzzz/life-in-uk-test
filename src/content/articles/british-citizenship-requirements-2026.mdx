...
description: "To become a British citizen you need 5 years' residence, ILR, B1 English, a Life in the UK test pass, and good character — full 2026 requirements."
date: "2026-04-30"
category: "Immigration"
readTime: "8 min read"
published: true
keywords: ["British citizenship requirements 2026", "how to become a British citizen 2026", "naturalisation requirements UK", "British citizenship checklist", "citizenship requirements after ILR", "requirements for British citizenship 2026", "5 requirements British citizenship", "British citizenship requirements checklist"]
---
...
If you have anything in your background that you are unsure about, get advice from an OISC-regulated immigration adviser before applying. You can also use our [free good character checker](/good-character-check) to assess your situation before applying.
...
Your test result is valid for life. If you passed the test for your ILR application, you use the same Unique Reference Number (URN) — sent to you by email on the day, not a printed certificate or letter — for your citizenship application. You do not need to retake it.

Enter your URN on your Form AN application; there is no document to upload or post.
...
2. **Pass the Life in the UK test before your ILR application.** You can then use the same Unique Reference Number (URN) for citizenship later. One test, two uses — and you only have to think about it once.
...
Yes. It is the same test. If you passed it for your ILR application, the same Unique Reference Number (URN) — sent by email, not a printed certificate — is used for citizenship. You do not retake the test.
