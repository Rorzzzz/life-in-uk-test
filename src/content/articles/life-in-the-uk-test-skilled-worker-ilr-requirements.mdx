...
💡 Run a [free mock exam](/exam) to check your score before booking your test  
...
**Step 3: Take timed mock exams.** Practise under real conditions. Use our [free mock exam](/exam) — 24 questions, 45 minutes, just like the real test.
...
The Life in the UK test is one item on the ILR checklist — but it is one that requires proper preparation. Use our [free practice questions](/practice) to start today. When you are scoring 90%+ in [mock exams](/exam), book your test centre slot and then turn your attention to the rest of your SET(O) application.
